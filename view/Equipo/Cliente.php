...
<?php 
    ...
    if (isset($_GET['id'])==null) {
        header('Location: index.php?view=Equipo');
    }

    $login=new Equipo(new Connexion);
    $login->setpkequipo($_GET['id']);
...
<?php 
    $antena=new Cliente(new Connexion);
    $antena->setfkequipo($xd['pk_equipo']);
    $res=$antena->getAllfkEquipo();

 ?>
  <div class="col-md-12">
              <div class="content-box-large">
                <div class="panel-heading">
                      <div class="panel-title"><h2>Clientes del Equipo : <?php echo $xd['nombre']; ?></h2></div>
